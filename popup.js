...
function setupHoverColorPicker() {
    ...
    function stopEyedropper() {
        document.removeEventListener('mousemove', getColor); // Remove color picking on stop
        document.removeEventListener('click', stopEyedropper); // Remove click event on stop
    }
}
